...
import { emailLogin, googleLogin, twitterLogin, githubLogin } from "../../config/auth";
...
function Signup() {
  ...
  const handleLogin = async () => {
    emailLogin(setLoading,setErr,email,password,navigate)
  };
  ...
  return (
    <div className="grid xl:grid-cols-3 md:grid-cols-1 max-sm:grid-cols-1">
      ...
      <div className="2xl:w-full xl:w-full lg:w-full 2xl:block xl:block max-md:hidden max-sm:hidden sm:hidden col-span-2 h-screen bg-gradient-to-r from-fuchsia-600 to-purple-600 rounded-l-[90px] overflow-hidden shadow-xl">
        <video
