    ...
    <div className="grid xl:grid-cols-3 md:grid-cols-1 max-sm:grid-cols-1">
      <div className="w-full h-screen flex items-center justify-center">
        <div className="max-sm:p-8">
          <img className="max-sm:w-14 xl:w-16 lg:w-16 md:w-16 m-auto mb-2" src={logo} alt="" />
      ...
      <div className="2xl:w-full xl:w-full lg:w-full 2xl:block xl:block max-md:hidden max-sm:hidden col-span-2 h-screen bg-gradient-to-r from-fuchsia-600 to-purple-600 rounded-l-[90px] overflow-hidden shadow-xl">
        <video
          className="max-sm:hidden xl:w-full xl:h-full lg:w-full lg:h-full object-cover opacity-50"
          src={video2}
          autoPlay
          loop
          muted
