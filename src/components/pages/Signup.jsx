...
function Signup() {
  ...
  return (
    <div className="grid xl:grid-cols-3 md:grid-cols-1 max-sm:grid-cols-1">
      ...
      <div className="w-full 2xl:block xl:block max-md:hidden max-sm:hidden sm:hidden col-span-2 h-screen bg-gradient-to-r from-fuchsia-600 to-purple-600 rounded-l-[90px] overflow-hidden relative">
        <video
